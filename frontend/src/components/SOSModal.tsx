...
export const SOSModal: React.FC = () => {
  ...
  const smsUri = `sms:1554?body=MAYDAY%20DISTRESS%20CALL%20-%20Vessel:%20Matsya%20Sagar%20IND-KA-04.%20Position:%20${lat}N,%20${lng}E.%20Require%20Immediate%20Assistance!`;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-200 select-none">
      <div className="bg-[#450A0A] border-2 border-[#EF4444] text-white w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl p-5 sm:p-6 space-y-4 max-h-[90vh] overflow-y-auto custom-scrollbar animate-in slide-in-from-bottom-6">
        ...
        {/* 2. DIRECT ONE-TAP CALL TO COAST GUARD */}
        <a
          href="tel:1554"
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <div className="font-black text-base sm:text-lg leading-tight">
                CALL COAST GUARD NOW
              </div>
              <div className="text-xs text-red-100">National Search & Rescue Toll-Free</div>
            </div>
          </div>
          <span className="font-mono text-2xl font-black">1554</span>
        </a>

        {/* 3. DISPATCH SMS BUTTON */}
        <a
          href={smsUri}
        ...
        >
          <Share2 size={18} />
          <span>SEND EMERGENCY SMS WITH GPS TO ICG</span>
        </a>
